...
def home(): 
    ...
    return "Welcome: Copy Paste any of the following routes to the end of the home page url (minus single quotes): '/api/v1.0/precipitation' '/api/v1.0/stations' '/api/v1.0/tobs' '/api/v1.0/<start_date>' '/api/v1.0/<start_date>/<end_date>'"
